...
Hooks are functions that get an <a target="_blank" href="https://pkg.go.dev/github.com/apocelipes/ent?tab=doc#Mutator">`ent.Mutator`<a> and return a mutator back.
